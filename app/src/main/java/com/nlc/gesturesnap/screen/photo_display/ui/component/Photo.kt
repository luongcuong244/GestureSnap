package com.nlc.gesturesnap.screen.photo_display.ui.component
...
fun BoxScope.Photo(photoDisplayViewModel: PhotoDisplayViewModel = viewModel()){
    ...
    val imageBitmap = rememberAsyncImagePainter(model = File(photoDisplayViewModel.photoInfo.value.path))
    ...
    LaunchedEffect(Unit) {
        ...
        BitmapFactory.decodeFile(photoDisplayViewModel.photoInfo.value.path, options)
